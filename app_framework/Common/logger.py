...
import os
import time
from app_framework.Common import dir_config
...
handler_2 = RotatingFileHandler(dir_config.logs_dir+"/APP_Autotest_{0}.log".format(curTime),backupCount=20,encoding='utf-8')
